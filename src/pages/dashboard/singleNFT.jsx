...
const Orgs = () => {
  ...
  const { dropdown, asset, transactionHistory, showSocial, text, isCopied } = state;
          ...
          <div className={classes.feature}>
            <div className={classes.mainDetails}>
              ...
              <div className={classes.icons}>
                ...
                <svg
                  className={`${classes.icon} ${classes.dots}`} width="6" height="18" viewBox="0 0 6 18" fill="none" xmlns="http://www.w3.org/2000/svg">
