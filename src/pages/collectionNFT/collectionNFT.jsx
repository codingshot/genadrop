...
const CollectionNFT = () => {
  ...
  const {
    dropdown, asset, transactionHistory, collection, isLoading, algoPrice, showSocial, isCopied,
  } = state;
  ...
  useEffect(() => {
    (async function getResult() {
      ...
      if (Object.keys(collections).length) {
        ...
        const result = collectionData.find((asset) => asset.Id === Number(nftId));
            ...
            <div className={classes.btns}>
              {
                (asset.sold
                  ...
                  : (
                    <>
                      <button className={classes.buy} disabled={asset.sold} onClick={buyNft}>
