...
import classes from "./AssetOverview.module.css";
import { GenContext } from "../../gen-state/gen.context";
import { addRule, clearPreview, clearRule, setConflictRule } from "../../gen-state/gen.actions";
import isUnique from "./AssetOverview-Script";
import ConflictRule from "../Conflict-Rule/ConflictRule";
...
const AssetOverview = () => {
  ...
  return (
    <div className={classes.container}>
            ...
            <>
              ...
              {showRule && (
                <div className={classes.ruleCardWrapper}>
                  <ConflictRule showRule={(e) => handleSetState({ showRule: e })} />
                </div>
              )}
            </>
          )}
      ...
      {layers.length ? (
        layers.map((layer) => <AssetMenu key={layer.id} layer={layer} />)
      ) : (
