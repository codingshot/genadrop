...
import classes from "./ConflictRule.module.css";
import leftArrow from "../../assets/icon-arrow-left-long.svg";
import { handleImage } from "../Asset-Preview/AssetPreview-Script";

const ConflictRule = ({ showRule }) => {
