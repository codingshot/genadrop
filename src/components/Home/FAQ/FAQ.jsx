...
const FQA = () => {
  ...
  const FAQS = [
    ...
    },
    {
      ...
      answer:
        "Connect your wallet and upload your collection zip folder, previously made in the create section of the Genadrop dApp. as json file after which you will now upload your Metadata to ipfs and select the blockchain of your choice, add price and Mint.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "To promote the decentralized stack, we do not have a backend to story assets. Rather this is handled on the client side. We only save contract references for things like collections on Algorand onto a database in order to build the marketplace with a Ethereum familiar UI.",
    },
    {
