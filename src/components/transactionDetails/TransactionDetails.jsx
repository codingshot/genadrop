            ...
            <table className={classes.table}>
                <tbody>
                    <tr>
                        ...
                        <td className={classes.txId} onClick={() => handleSetState({ showDrop: true })} ref={wrapperRef}> {breakAddress(data.data.txId)}
                            {showDrop && data.data.txId ?

                                isCopied ?

                                    <div className={classes.copied}>Copied!
                                    </div> :
                    ...
                    {data.data.price ? <tr>
                        <td>Amount ID</td>
                        <td className={classes.icon}> {data.data.price}<img src={algoIcon} alt="" /> </td>
                    </tr> : ""}
