      ...
      {preview ? (
        ...
        <div className={classes.wrapper}>
          ...
          <section className={classes.mintOptions}>
            <div className={classes.inputWrapper}>
              ...
              {chainId ? (
                <div className={classes.price}>
                  ...
                  <span>
                    {dollarPrice.toFixed(2)} {getUintByChain[chain?.label]}
                  </span>
                </div>
              ) : (
            ...
            <div className={classes.inputWrapper}>
              <label>
                Chain:{' '}
                {chainId ? (
                  <span className={classes.chain}> {chain?.label}</span>
                ) : (
                  '---'
                )}{' '}
              </label>
          ...
          <section className={classes.mintButtonWrapper}>
            <button onClick={setMint} className={classes.mintBtn}>
              Mint
            </button>
            <button onClick={changeFile} className={classes.cancelBtn}>
              Cancel
            </button>
          </section>
        </div>
