          ...
          <div className={classes.rules}>
            {
              isRule ?
                <>
                  <button onClick={handleAddRule} className={classes.addRuleBtn}>Add Rule</button>
                  <button onClick={closeRule} className={classes.showRuleBtn}>Cancel <span>0</span></button>
                </>
                :
                <>
