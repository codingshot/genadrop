...
contract NFTMarketV2 is UUPSUpgradeable, ReentrancyGuardUpgradeable, EIP712Upgradeable  {
    ...
    function nftSale(uint256 price, uint256 tokenId, address seller, address nftContract)
        public
        payable
        nonReentrant
    {
